...
namespace UXF{
    ...
    /// </summary>
    public class PositionRotationTrackerCustomForGridProject : Tracker{
        public override string MeasurementDescriptor => "movement";
        public override IEnumerable<string> CustomHeader => new string[] { "pos_x", "pos_y", "pos_z", "rot_x", "rot_y", "rot_z", "moving"};
        ...
        protected override UXFDataRow GetCurrentValues(){
            ...
            var values = new UXFDataRow(){
                ...
                ("rot_y", r.y),
                ("rot_z", r.z),
                ("moving", ThreeButtonMovement.movingForward)
            };
