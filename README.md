...
- _trial\_num_ = Number of the trial (special UXF name check their documentation). This will determine the order in which the trials are presented to the participant. 
- _block\_num_ = Number of the block (special UXF name check their documentation).
...
- _start\_x_ = Start location of the player where they are teleported to. In continuous mode, only relevant on trial 1. 
- _start\_z_ = Start location of the player where they are teleported to. In continuous mode, only relevant on trial 1. 
- _start\_yRotation_ = Start rotation/heading angle of the player in degrees (0 - 360). In continuous mode, only relevant on trial 1.
